...
public class Controller extends Joystick{
	...
	public Controller(int port){super(port); this.port = port;}
	...
	@Override public int getPOV(){return isConnected() ? super.getPOV() : -1;}
	...
	public ControllerButton button(int button){return new ControllerButton(this, button);}
}
